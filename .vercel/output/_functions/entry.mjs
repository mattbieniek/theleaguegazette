...
var middlewareSecret = "557bf260-d98f-4761-a497-5994fd440f1a";
//#endregion
...
var _page0 = () => import("./chunks/generic_DFs598zB.mjs");
var _page1 = () => import("./chunks/_id__BhBoIPGV.mjs");
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "557bf260-d98f-4761-a497-5994fd440f1a") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
