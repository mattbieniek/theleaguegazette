...
var middlewareSecret = "dab47c0b-f31f-44e0-aef8-0845c2e83153";
//#endregion
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "dab47c0b-f31f-44e0-aef8-0845c2e83153") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
